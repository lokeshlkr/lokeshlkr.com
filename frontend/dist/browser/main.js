...
var _HistoryStateManager = class _HistoryStateManager extends StateManager {
  ...
  setBrowserUrl(url, transition2) {
    ...
    if (this.location.isCurrentPathEqualTo(path) || !!transition2.extras.replaceUrl) {
      ...
      const state = __spreadValues(__spreadValues({}, transition2.extras.state), this.generateNgRouterState(transition2.id, currentBrowserPageId));
      this.location.replaceState(path, "", state);
    } else {
      const state = __spreadValues(__spreadValues({}, transition2.extras.state), this.generateNgRouterState(transition2.id, this.browserPageId + 1));
...
// src/02_game/home/home.component.ts
var _HomeComponent = class _HomeComponent {
};
_HomeComponent.\u0275fac = function HomeComponent_Factory(t) {
  return new (t || _HomeComponent)();
};
_HomeComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HomeComponent, selectors: [["tiar-home"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 14, vars: 0, consts: [[1, "cc", "mt-20"], [1, "w-80", "flex", "flex-col", "gap-4"], [1, "btn", "text-2xl"], ["routerLink", "rules", 1, "btn", "text-2xl"], ["routerLink", "settings", 1, "btn", "text-2xl"]], template: function HomeComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "button", 2);
    \u0275\u0275text(3, "Play Online");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "button", 2);
    \u0275\u0275text(5, "Play against bot");
    \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HomeComponent, { className: "HomeComponent", filePath: "src\\02_game\\home\\home.component.ts", lineNumber: 11 });
})();
...
// src/01_ui/fancy-input/fancy-input.component.ts
var _c0 = (a0, a1) => ({ "!border-error/50": a0, "!border-success/50": a1 });
function FancyInputComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "input", 6);
    \u0275\u0275listener("ngModelChange", function FancyInputComponent_Conditional_6_Template_input_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.valueChanged($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(1, "input", 7);
    \u0275\u0275listener("ngModelChange", function FancyInputComponent_Conditional_6_Template_input_ngModelChange_1_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.valueChanged($event));
    })("blur", function FancyInputComponent_Conditional_6_Template_input_blur_1_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.touched.set(true));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("ngModel", ctx_r1.value());
    \u0275\u0275advance();
    \u0275\u0275property("type", ctx_r1.type())("id", ctx_r1.id() || "text")("ngModel", ctx_r1.value());
  }
}
function FancyInputComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "input", 8);
    \u0275\u0275listener("ngModelChange", function FancyInputComponent_Conditional_7_Template_input_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.valueChanged($event));
    })("blur", function FancyInputComponent_Conditional_7_Template_input_blur_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.touched.set(true));
    });
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("type", ctx_r1.type())("id", ctx_r1.id() || "text")("ngModel", ctx_r1.value())("ngClass", \u0275\u0275pureFunction2(4, _c0, ctx_r1.error() && ctx_r1.touched(), !ctx_r1.error() && ctx_r1.dirty() && ctx_r1.touched()));
  }
}
function FancyInputComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("@errorAnimation", ctx_r1.error());
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.error(), " ");
  }
}
var _FancyInputComponent = class _FancyInputComponent {
  constructor() {
    this.type = input();
...
_FancyInputComponent.\u0275fac = function FancyInputComponent_Factory(t) {
  return new (t || _FancyInputComponent)();
};
_FancyInputComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FancyInputComponent, selectors: [["tiar-input"]], inputs: { type: [1, "type"], id: [1, "id"], label: [1, "label"], validator: [1, "validator"], value: [1, "value"] }, outputs: { valueChange: "valueChange" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 9, vars: 4, consts: [[1, "relative", "pb-[1em]", "mb-2", "container"], [1, "container", "flex", "h-full", "items-stretch", "overflow-hidden", "rounded-sm"], [1, "pl-4", "min-w-[30%]", "max-w-[50%]", "transition", "flex", "items-center", "border-fg/50", 3, "for"], [1, "cc", "mx-1"], ["autofocus", "", 1, "w-full", "transition", "bg-bg-lighter/30", "focus:bg-bg-darker", "py-1", "pl-1", "pr-4", "outline-none", "z-10", "border-b-2", "border-fg/50", 3, "type", "id", "ngModel", "ngClass"], [1, "text-tiny", "absolute", "right-2", "bottom-0", "text-error", "z-0"], ["type", "text", 1, "w-full", "font-mono", "transition", "bg-bg-lighter/30", "focus:bg-bg-darker", "pl-1", "pr-4", "outline-none", "z-10", "border-b-2", "border-fg/50", 3, "ngModelChange", "ngModel"], ["autofocus", "", 1, "w-24", "transition", "bg-bg-lighter/30", "focus:bg-bg-darker", "outline-none", "z-10", "cursor-context-menu", 3, "ngModelChange", "blur", "type", "id", "ngModel"], ["autofocus", "", 1, "w-full", "transition", "bg-bg-lighter/30", "focus:bg-bg-darker", "py-1", "pl-1", "pr-4", "outline-none", "z-10", "border-b-2", "border-fg/50", 3, "ngModelChange", "blur", "type", "id", "ngModel", "ngClass"]], template: function FancyInputComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5, ":");
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, FancyInputComponent_Conditional_6_Template, 2, 4)(7, FancyInputComponent_Conditional_7_Template, 1, 7, "input", 4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(8, FancyInputComponent_Conditional_8_Template, 2, 2, "div", 5);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx.type() === "color" ? 6 : 7);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.error() && ctx.touched() ? 8 : -1);
  }
}, dependencies: [FormsModule, DefaultValueAccessor, NgControlStatus, NgModel, CommonModule, NgClass], data: { animation: [
...
var FancyInputComponent = _FancyInputComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FancyInputComponent, { className: "FancyInputComponent", filePath: "src\\01_ui\\fancy-input\\fancy-input.component.ts", lineNumber: 27 });
})();

// src/10_utility/functions.ts
function isValidHexColor(value) {
  if (value.length !== 7 || value[0] !== "#" || parseInt(value.slice(1, 7)) === parseInt(value.slice(1, 6))) {
    return false;
  }
  return true;
}

// src/02_game/settings/settings.component.ts
var _SettingsComponent = class _SettingsComponent {
  constructor() {
    this.name = signal(localStorage.getItem("playerName") || "");
    this.color = signal(localStorage.getItem("playerColor") || "#004578");
  }
  validateName() {
...
_SettingsComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SettingsComponent, selectors: [["tiar-settings"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 11, vars: 6, consts: [[1, "text-center", "text-3xl"], [1, "max-w-96", "cc", "mx-auto", "py-4"], [1, "flex", "flex-col", 3, "submit"], ["label", "Name", 3, "valueChange", "id", "value", "validator"], ["label", "Color", "type", "color", 3, "valueChange", "id", "value", "validator"], [1, "self-end"], ["type", "submit", 1, "btn", "btn-primary"], ["type", "button", "routerLink", "/", 1, "btn"]], template: function SettingsComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "h1", 0);
    \u0275\u0275text(1, "Manage your profile");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "div", 1)(3, "form", 2);
    \u0275\u0275listener("submit", function SettingsComponent_Template_form_submit_3_listener($event) {
      return ctx.onSubmit($event);
    });
    \u0275\u0275elementStart(4, "tiar-input", 3);
    \u0275\u0275twoWayListener("valueChange", function SettingsComponent_Template_tiar_input_valueChange_4_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.name, $event) || (ctx.name = $event);
      return $event;
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "tiar-input", 4);
    \u0275\u0275twoWayListener("valueChange", function SettingsComponent_Template_tiar_input_valueChange_5_listener($event) {
  ...
  if (rf & 2) {
    \u0275\u0275advance(4);
    \u0275\u0275property("id", "playerName");
    \u0275\u0275twoWayProperty("value", ctx.name);
    \u0275\u0275property("validator", ctx.validateName);
    \u0275\u0275advance();
    \u0275\u0275property("id", "playerColor");
    \u0275\u0275twoWayProperty("value", ctx.color);
    \u0275\u0275property("validator", ctx.validateColor);
  }
}, dependencies: [FancyInputComponent, RouterLink] });
var SettingsComponent = _SettingsComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SettingsComponent, { className: "SettingsComponent", filePath: "src\\02_game\\settings\\settings.component.ts", lineNumber: 13 });
})();

// src/02_game/rules/rules.component.ts
var _RulesComponent = class _RulesComponent {
};
_RulesComponent.\u0275fac = function RulesComponent_Factory(t) {
  return new (t || _RulesComponent)();
};
_RulesComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RulesComponent, selectors: [["tiar-rules"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 2, vars: 0, template: function RulesComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1, "rules works!");
    \u0275\u0275elementEnd();
  }
} });
var RulesComponent = _RulesComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RulesComponent, { className: "RulesComponent", filePath: "src\\02_game\\rules\\rules.component.ts", lineNumber: 10 });
})();

// src/00_app/app.routes.ts
var routes = [
...
var _AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const moduleImpl = this.moduleImpl ?? import("./chunk-LGIOR2PO.js").then((m) => m);
...
// src/00_app/app.config.ts
var appConfig = {
  providers: [provideExperimentalZonelessChangeDetection(), provideAnimationsAsync(), provideRouter(routes)]
};

// src/01_ui/icon/icon.component.ts
var _c02 = ["class", "kit"];
...
_AppComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["tiar-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 12, vars: 0, consts: [[1, "site", "max-w-[800px]", "mx-auto", "bg-bg-lighter/20", "p-4", "min-h-[100dvh]", "h-[100dvh]"], [1, "container", "grid", "grid-rows-[min-content_1fr_min-content]", "gap-4", "h-full"], [1, "text-center"], [1, "text-5xl", "font-bold"]], template: function AppComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "header", 2)(3, "h1", 3);
    \u0275\u0275text(4, "Three in a row!");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p");
    \u0275\u0275text(6, "An online game inspired by a board game called ");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppComponent, { className: "AppComponent", filePath: "src\\00_app\\app.component.ts", lineNumber: 14 });
})();
